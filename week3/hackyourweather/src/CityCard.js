...
function CityCard({ cityInf, index, removeCity }) {
    ...
    return (
        <div className="card">
            <button onClick={() => removeCity(cityInf.id)} style={{ backgroundColor: 'transparent', border: 'none', cursor: 'pointer', color: 'red', fontSize: '35px', position: 'absolute', top: '3px', right: '2px' }}><i className="far fa-times-circle"></i></button>
